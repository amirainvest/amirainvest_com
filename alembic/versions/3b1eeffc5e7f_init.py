...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "last_updated", sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True
        ),
        sa.Column(
            "created_at", sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("pending", "running", "succeeded", "failed", name="brokeragejobsstatus"), nullable=False
        ),
    ...
    op.create_table(
        "financial_account_current_holdings",
        sa.Column("id", sa.BigInteger(), nullable=False),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("post_id", sa.Integer(), nullable=False),
        sa.Column(
            "liked_at", sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True
        ),
        sa.ForeignKeyConstraint(["post_id"], ["posts.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.Column("post_id", sa.Integer(), nullable=False),
        sa.Column(
            "read_at", sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True
        ),
