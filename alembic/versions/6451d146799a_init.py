...
Revision ID: 6451d146799a
Revises: c55cbc17cbac
Create Date: 2022-02-02 17:05:57.593248
...
revision = '6451d146799a'
down_revision = 'c55cbc17cbac'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('collect', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    sa.Column('is_benchmark', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('human_readable_name'),
    sa.UniqueConstraint('id'),
    sa.UniqueConstraint('ticker_symbol')
    )
    op.create_index(op.f('ix_securities_collect'), 'securities', ['collect'], unique=False)
    op.create_index(op.f('ix_securities_is_benchmark'), 'securities', ['is_benchmark'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.Column('last_updated', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.ForeignKeyConstraint(['financial_institution_id'], ['financial_institutions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
    sa.UniqueConstraint('security_id', 'price_time')
    )
    op.create_table('users',
    sa.Column('id', postgresql.UUID(), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('benchmark', sa.Integer(), nullable=False),
    ...
    sa.Column('trading_strategies', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.ForeignKeyConstraint(['benchmark'], ['securities.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('subscriber_id', postgresql.UUID(), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'running', 'succeeded', 'failed', name='jobsstatus'), server_default='pending', nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('requestor_id', postgresql.UUID(), nullable=False),
    sa.Column('platform', sa.Enum('youtube', 'substack', 'twitter', 'brokerage', 'amira', name='mediaplatform'), nullable=False),
    sa.Column('platform_id', sa.String(), nullable=False),
    sa.Column('provided_name', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.Column('fulfilled', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.Column('subscription_level', sa.Enum('standard', 'premium', name='subscriptionlevel'), server_default='standard', nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    ...
    sa.Column('user_id', postgresql.UUID(), nullable=False),
    sa.Column('platform', sa.Enum('youtube', 'substack', 'twitter', 'brokerage', 'amira', name='mediaplatform'), nullable=False),
    sa.Column('first_error_at', sa.String(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    ...
    sa.Column('subscriber_id', postgresql.UUID(), nullable=False),
    sa.Column('creator_id', postgresql.UUID(), nullable=False),
    sa.Column('subscription_level', sa.Enum('standard', 'premium', name='subscriptionlevel'), server_default='standard', nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], ondelete='CASCADE'),
    ...
    sa.Column('plaid_id', sa.String(), nullable=False),
    ...
    sa.Column('substack_user', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(), nullable=False),
    sa.Column('summary', sa.String(), nullable=False),
    sa.Column('url', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.ForeignKeyConstraint(['substack_user'], ['substack_users.id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('account_id', 'plaid_security_id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=True),
    sa.ForeignKeyConstraint(['account_id'], ['financial_accounts.id'], ),
    sa.ForeignKeyConstraint(['security_id'], ['plaid_securities.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_securities_is_benchmark'), table_name='securities')
