...
Revision ID: be92cb0c9026
Revises: df88edb19522
Create Date: 2021-12-30 18:11:39.135317
...
revision = 'be92cb0c9026'
down_revision = 'df88edb19522'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(None, 'historical_jobs', ['id'])
...
def downgrade():
    ...
    op.drop_constraint(None, 'historical_jobs', type_='unique')
