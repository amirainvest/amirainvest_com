...
async def create_route(husk_request_data: CreateModel, token=Depends(auth_depends_user_id)):
...
async def delete_route(husk_request_id: int, token=Depends(auth_depends_user_id)):
