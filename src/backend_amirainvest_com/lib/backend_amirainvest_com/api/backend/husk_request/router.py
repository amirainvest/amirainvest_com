...
from backend_amirainvest_com.api.backend.husk_request.model import CreateModel, GetModel, ListModel
...
async def list_route():
    ...
    return {"results": husk_request_data, "result_count": len(husk_request_data)}
