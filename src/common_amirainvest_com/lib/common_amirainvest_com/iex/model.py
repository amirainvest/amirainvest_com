...
class CompanyQuoteLogo(BaseModel):
    symbol: str
    ...
    closeTime: Optional[decimal.Decimal]
    currency: Optional[str]
    delayedPrice: Optional[decimal.Decimal]
    delayedPriceTime: Optional[decimal.Decimal]
    ...
    extendedPriceTime: Optional[decimal.Decimal]
    high: Optional[decimal.Decimal]
    highSource: Optional[str]
    highTime: Optional[decimal.Decimal]
